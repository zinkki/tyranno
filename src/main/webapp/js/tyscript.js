...
const colors = [
{ main: '#fff', shades: ['#70b984', '#FCE790', '#4abf58', '#E4C650'] },
{ main: '#fff', shades: ['#a4ca94', '#70b984', '#DD8644', '#4abf58'] },
{ main: '#fff', shades: ['#70b984', '#a4ca94', '#70b984', '#C04567'] },
{ main: '#fff', shades: ['#4abf58', '#C19FC7', '#a4ca94', '#70b984'] },
{ main: '#fff', shades: ['#83c18b', '#4abf58', '#4D6CA3', '#a4ca94'] },
{ main: '#fff', shades: ['#4abf58', '#73CDBF', '#4abf58', '#4D6CA3'] },
{ main: '#fff', shades: ['#a4ca94', '#4abf58', '#68A87A', '#4abf58'] }];
/*[
{ main: '#222', shades: ['#FAE073', '#FCE790', '#FADD65', '#E4C650'] },
{ main: '#222', shades: ['#F7B989', '#F9CDAA', '#DD8644', '#F39C59'] },
{ main: '#222', shades: ['#EE7293', '#F191AB', '#D64D72', '#C04567'] },
{ main: '#222', shades: ['#B084B6', '#C19FC7', '#916198', '#82588A'] },
{ main: '#222', shades: ['#6382B9', '#829BC7', '#4D6CA3', '#3E5782'] },
{ main: '#222', shades: ['#4DBFAD', '#73CDBF', '#27A18D', '#1F8171'] },
{ main: '#222', shades: ['#7FBE90', '#98CBA6', '#68A87A', '#5E976E'] }];*/

const svg = selectSVG('svg_typing');
const text = document.getElementById('text_typing');
const offscreenText = document.getElementById('offscreen-text');
const input = document.getElementById('input_typing');
let width = window.innerWidth;
let height = window.innerHeight;
let textSize = 0;
let textCenter = 0;
const letters = [];
const prompt = ['O','U','R',' ','P','O','R','T','F','O','L','I','O'];
let runPrompt = true;
